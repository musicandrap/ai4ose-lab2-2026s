...
impl SyncExperiment {
    ...
    fn run_failure_tests(&self) -> Vec<(&'static str, bool)> {
        ...
        vec![
            ...
            ("condvar_usage", failure_tests::test_incorrect_condvar_usage().is_ok()),
            ("double_lock", failure_tests::test_double_lock_deadlock().is_ok()),
            ("circular_wait", failure_tests::test_circular_wait_deadlock().is_ok()),
        ]
    }
